...
HotKey="/home/kkleytt/.config/caelestia/cli/scripts/media/screenshot/screenshot.sh"
...
check_keybinds() {
    ...
    case "$status_code" in
        ...
        10) "$HotKey" "screen" "none" "true" "true" "false" "false"; exit 0 ;;
        11) "$HotKey" "window" "none" "true" "true" "false" "false"; exit 0 ;;
        12) "$HotKey" "region" "none" "true" "true" "false" "false"; exit 0 ;;
        
        # Обычные скрины ( -Annotate | -Freeze )
        13) "$HotKey" "screen" "none" "true" "false" "talse" "false"; exit 0 ;;
        14) "$HotKey" "window" "none" "true" "false" "talse" "false"; exit 0 ;;
        15) "$HotKey" "region" "none" "true" "false" "talse" "false"; exit 0 ;;
        
        # Быстрые замороженные ( -Notify | -Annotate )
        16) "$HotKey" "screen" "none" "true" "true" "false" "talse"; exit 0 ;;
        17) "$HotKey" "window" "none" "true" "true" "false" "talse"; exit 0 ;;
        18) "$HotKey" "region" "none" "true" "true" "false" "talse"; exit 0 ;;
        
        # Ctrl + {}
        # С Satty ( -Notify | -Freeze )
        19) "$HotKey" "screen" "satty" "true" "true" "false" "false"; exit 0 ;;
        20) "$HotKey" "window" "satty" "true" "true" "false" "false"; exit 0 ;;
        21) "$HotKey" "region" "satty" "true" "true" "false" "false"; exit 0 ;;
        
        # С Gradia ( -Notify | -Freeze )
        22) "$HotKey" "screen" "gradia" "true" "true" "false" "false"; exit 0 ;;
        23) "$HotKey" "window" "gradia" "true" "true" "false" "false"; exit 0 ;;
        24) "$HotKey" "region" "gradia" "true" "true" "false" "false"; exit 0 ;;
        
        # С Satty freeze ( -Notify )
        25) "$HotKey" "screen" "satty" "true" "true" "false" "talse"; exit 0 ;;
        26) "$HotKey" "window" "satty" "true" "true" "false" "talse"; exit 0 ;;
        27) "$HotKey" "region" "satty" "true" "true" "false" "talse"; exit 0 ;;
...
take_screenshot() {
  ...
  "$HotKey" "$method" "$annotate" "true" "$save" "$save" "$freeze"
}
