...
app = typer.Typer(help="Управление тачскрином")

# Путь к вашему bash-скрипту
SCRIPT_PATH = SCRIPTS_DIR / "peripherals" / "touchscreen" / "script.sh"
...
def get(notify: bool = True):
    """Получить текущий статус тачскрина"""
...
def toggle(notify: bool = True):
    """Переключить тачскрин в состояние Enable/Disable"""
