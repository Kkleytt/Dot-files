...
app = typer.Typer(help="Управление мышкой")

# Путь к вашему bash-скрипту
SCRIPT_PATH = SCRIPTS_DIR / "peripherals" / "mouse" / "script.sh"
...
def toggle(notify: bool = True):
    """Переключить мышку в состояние Enable/Disable"""
